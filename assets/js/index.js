...
$(function () {
    ...
    function getTpl() {
        ...
        const xf_rest_time = {
            restTime: [
                { work: '08:00 起床', img: 'assets/upload/get_up.png' },
                { work: '12:00 吃饭', img: 'assets/upload/lunch.png' },
        ...
        const xf_site = {
            siteInfo: [
                { name: '芝麻', links: 'https://zhimaweb.github.io/', pic: 'https://zhimaweb.github.io/zhima.png' },
                { name: 'GoC', links: 'https://zhimaweb.github.io/GoC', pic: 'https://zhimaweb.github.io/GoC/Goc.png' },
            ]
        }
        ...
        const xf_friend = {
            friendInfo: [
                { img: 'logo.png', links: 'https://zhimaweb.github.io/', name: '芝麻', sig: '热爱编程' },
                { img: 'logo.png', links: 'hqxhsm.html', name: '???', sig: '????%&#^??$^&^%?' },
            ]
        }
    ...
    let webTime = new Date('2024-08-11') // 这里修改建站时间
    ...
    function switchContent() {
        ...
        if ($('.xf_btn_sw').hasClass('xf_active')) {
            $home.fadeOut(500, function () {
                $friend.fadeIn()
                $('.xf_btn_sw span').text('主页 >')
            })
        } else {
            $friend.fadeOut(500, function () {
                $home.fadeIn()
                $('.xf_btn_sw span').text('友情链接 >')
            })
        }
    }
    $(window).scroll(() => {
